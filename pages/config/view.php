        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="post">
              ...
              <!-- /.box-body -->
        <div class="box-footer">
          <button type="submit" class="btn btn-primary" >Submit</button><a href="">Back</a>
        </div>
            </form>
          </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <button type="button" class="btn btn-danger btn-flat btn-sm">Action</button>
                  <button type="button" class="btn btn-danger btn-flat dropdown-toggle btn-sm" data-toggle="dropdown" aria-expanded="false">
                    <span class="caret"></span>
                    <span class="sr-only">Toggle Dropdown</span>
                  </button>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#">Edit User Details</a></li>
                    <li><a href="#">Edit Privileges</a></li>
                    <li><a href="#">Delete User</a></li>
                    <li><a href="#"><i class="glyphicon glyphicon-flag"></i>Red Flag</a></li>
                  </ul>
                </div></td>
                </tr>
                <tr>
