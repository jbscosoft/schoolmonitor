   ...
   <div class="row">
      <div class="col-xs-12">
         <div class="box box-primary">
                     ...
                     <?php
                        //we shall need  a condition to specify the university
                             ...
                             if (!$query_run) {
                               ...
                               <td>$gradLoad</td>
                               <td>$category</td>
                               <td><a href='?edit_programme=" . $row['programmeID'] . "' class='btn btn-primary btn-sm'><i class='glyphicon glyphicon-eye-open'></i>&nbsp;|&nbsp; Edit</a>
                               <a href='?delete_programme=" . $row['programmeID'] . "' class='btn btn-danger btn-sm' data-toggle='tooltip' title='Delete Record!'><i class='glyphicon glyphicon-trash'></i>&nbsp;|&nbsp; Del</a>
                               </td>
                             </tr>
                            ";
                            $i++;
            ...
            <div class="col-md-2">
               <a href="<?php echo '?token='.base64_encode('add_programme') ?>"  class="btn  btn-success btn-flat " style='margin-top:3%;'><i class="fa fa-plus"></i>&nbsp;Add Programme</a>
            </div>
            <!-- /.box-body -->
         </div>
         <!-- /.box -->
